...
<?php if($msg){?><center><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </center><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<td>
<textarea name="vehicalorcview" rows="3" required><?php echo htmlentities($result->VehiclesOverview);?></textarea>
</td>
<tr>
<td>Price Per Day(in USD)<span style="color:red">*</span></td>
<td>
...
<td>
    <input type="text" name="modelyear" value="<?php echo htmlentities($result->ModelYear);?>" required>
</td>
...
<tr>
    <td colspan="5"><hr>
<h2><b>Vehicle Images</b></h2>
</td>
</tr>
<tr>
    <td style="width:43%;">
Image 1<br> <img src="vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<br><br><a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 1</a>
</td>
<td style="width:43%;">
Image 2<br><img src="vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<br><br><a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 2</a>
</td>
<td style="width:43%;">
Image 3<br><img src="vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<br><br><a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 3</a>
</td>
...
{?>
<input type="checkbox"  name="airconditioner" checked value="1">
...
<label for="inlineCheckbox2">Central Locking</label></div>
<?php } ?>
</td>
<td>
...
<button id="button" name="submit" type="submit" >Save changes</button>
</td></tr>
</table>
</center>
    </body>
